...
console.log(sumAll(aNumber.toString().split(" ").map(x => Number(x)))); // <--- You can edit this line  
console.log(sumAll(moreNumbers)); // <--- You can edit this line  
console.log(sumAll(aCalculatedNumber.toString().split(" ").map(x => Number(x)))); // <--- You can edit this line   
console.log(sumAll(Object.entries(anObjectOfNumbers).map(x=> x[1]))); // <--- You can edit this line  
